...
const component_index_template_1 = tslib_1.__importDefault(require("../../../scaffold-config/src/component-index-template"));
class WizardActions {
    constructor(ctx) {
        this.ctx = ctx;
    }
    ...
    async detectFrameworks() {
        ...
        const thirdParty = await (0, scaffold_config_1.detectThirdPartyCTFrameworks)(this.ctx.currentProject);
