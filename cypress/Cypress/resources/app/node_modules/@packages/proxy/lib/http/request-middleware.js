...
const MaybeAttachCrossOriginCookies = function () {
    ...
    const shouldCookiesBeAttachedToRequest = (0, cookies_1.shouldAttachAndSetCookies)(this.req.proxiedUrl, currentAUTUrl, this.req.requestedWith, this.req.credentialsLevel, this.req.isAUTFrame);
...
const MaybeSetBasicAuthHeaders = function () {
    ...
    if ((remoteState === null || remoteState === void 0 ? void 0 : remoteState.auth) && reqNeedsBasicAuthHeaders(this.req, remoteState)) {
...
const SendRequestOutgoing = function () {
    ...
    (_a = this.req.res) === null || _a === void 0 ? void 0 : _a.on('finish', () => {
