...
exports.testingTypeBreakingOptions = exports.breakingRootOptions = exports.breakingOptions = exports.options = exports.defaultSpecPattern = void 0;
...
const driverConfigOptions = [
    {
        ...
        defaultValue: (options = {}) => options.testingType === 'component' ? ['**/__snapshots__/*', '**/__image_snapshots__/*'] : '*.hot-update.js',
        validation: validate.isStringOrArrayOfStrings,
        overrideLevel: 'any',
    }, {
